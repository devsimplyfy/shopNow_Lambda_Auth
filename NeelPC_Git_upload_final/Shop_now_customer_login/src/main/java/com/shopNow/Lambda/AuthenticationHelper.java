...
class AuthenticationHelper {
    ...
    String PerformSRPAuthentication(String username, String password) throws Exception {
        ...
        try {
            ...
            if (ChallengeNameType.PASSWORD_VERIFIER.toString().equals(initiateAuthResult.getChallengeName())) {
                ...
                System.out.println("Challenge Request\t"+challengeRequest);
                RespondToAuthChallengeResult result = cognitoIdentityProvider.respondToAuthChallenge(challengeRequest);
                //System.out.println("REACHED HERE");
                //System.out.println(result);
               // System.out.println("ID\t"+CognitoJWTParser.getPayload(result.getAuthenticationResult().getIdToken()));
              // System.out.println("Acesss\t"+CognitoJWTParser.getPayload(result.getAuthenticationResult().getAccessToken()));
              // System.out.println("Refresh\t"+CognitoJWTParser.getPayload(result.getAuthenticationResult().getRefreshToken()));
                
              authresult = result.getAuthenticationResult().getRefreshToken();
     ...
     * @throws Exception 
     */
    private InitiateAuthRequest initiateUserSrpAuthRequest(String username) throws Exception {
        ...
        String s = "";
       //initiateAuthRequest.addAuthParametersEntry("SECRET_HASH", this.calculateSecretHash(this.clientId,s,username));
       // initiateAuthRequest.addAuthParametersEntry("SECRET_HASH", this.getSecretHash(this.clientId,s,username));
    ...
    private String calculateSecretHash(String userPoolClientId, String userPoolClientSecret, String userName) {
        ...
        try {
            ...
            System.out.println("\nMAC5");
            System.out.println("\nENCODE\t"+Base64.encodeAsString(rawHmac));
    ...
    private String getSecretHash(String appClientId, String appSecretKey, String email) throws Exception {
